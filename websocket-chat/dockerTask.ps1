...
.PARAMETER Clean
Removes the image websocket-chat and kills all containers based on that image.
...
Build a Docker image named websocket-chat
#>
...
$imageName="websocket-chat"
$projectName="websocketchat"
$serviceName="websocket-chat"
